...
import ChatLabel from './ChatLabel'; // Add this line to import ChatLabel
    ...
    <div className={`flex flex-col justify-between bg-[#212327] pt-7 transition-all z-50 max-md:absolute max-md:h-screen 
      ...
      <div>
        ...
        <div className={`mt-8 text-white/25 text-sm ${expand ? "block" : "hidden"}`}>
          ...
          {chats.map((chat, index)=><ChatLabel key={index} name={chat.name} id={chat_id} openMenu={openMenu} setOpenMenu={setOpenMenu}/>)}
      ...
      <div>
        ...
        <div className={`flex items-center cursor-pointer group relative ${
          ...
          <div className={`absolute -top-60 pb-8 ${!expand && "-right-40"}
            opacity-0 group-hover:opacity-100 hidden group-hover:flex transition`}>
