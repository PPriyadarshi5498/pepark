...
const ChatLabel = ({openMenu, setOpenMenu}) => {
  return (
    ...
    text-white/80 hover:bg-white/10 rounded-lg text-sm group cursor-pointer'>
      ...
      <p className='group-hover:max-w-[83.33%] truncate'>Chat Name Here</p>
      ...
      aspect-square hover:bg-black/80 rounded-lg'>
        ...
        <div className={`absolute ${openMenu.open ? 'block' : 'hidden'} -right-36 top-6 bg-gray-700 rounded-xl w-max p-2 z-10 hidden group-hover:block`}>
